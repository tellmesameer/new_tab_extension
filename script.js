...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const SHORTCUT_PRESET_NAMES = ["Youtube", "Gmail", "Aniwatch", "WhatsApp", "Instagram", "Twitter"];
