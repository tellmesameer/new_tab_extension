window.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        const defaultApiKey = 'caca88c94d79488eb13130924240110'; // Default Weather API key
        ...
        const weatherApi = `https://api.weatherapi.com/v1/current.json?key=caca88c94d79488eb13130924240110&q=Chandigarh&aqi=no`;
